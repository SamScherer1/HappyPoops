...
- (void)viewDidLoad {
    ...
    [self.foodTypeTableView registerClass:SAMMealSettingsCell.class forCellReuseIdentifier:@"SettingsCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    SAMMealSettingsCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SettingsCell" forIndexPath:indexPath];
